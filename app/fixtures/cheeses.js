export const cheeses = [
      ...
      {
        "id": "3a094d4b-5119-4f59-999d-7dba3458d50b",
        "name": "Bérouette",
        "content": "La Bérouette est une spécialité suisse au lait cru de vache. Elle est fabriquée à Rougemont, au pied de Gstaad. C'est un fromage ultra crémeux et gourmand aux notes lactées.",
        "image": "/assets/images/berouette.jpg"
      },
      {
        "id": "363843e3-246a-461e-bc19-713da651722d",
        "name": "Bethmale",
        "content": "La légende raconte que c'est sous l'occupation des Maures au XIVème siècle que serait né ce fromage aux confins des Pyrénées Ariégeoises. Sa croûte beige retournée et frottée tous les jours renferme un fromage ayant une pâte onctueuse et un caractère affirmé, presque animal. C'est sans doute le fromage au lait de vache le plus connu des Pyrénées ",
        "image": "/assets/images/bethmale.jpg"
      }
    ];
